...
public class Sendstring extends Activity
{
	...
	private static final String ACTION_USB_PERMISSION =    "com.se.chalmers.roa.USB_PERMISSION";	
	...
	/*constructor*/
	public Sendstring(Context context, SharedPreferences sharePrefSettings){
		super();
